        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_service_jobs_customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_service_jobs_tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_service_jobs_users_AssignedTechnicianId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_AssignedTechnicianId_ScheduledStartUtc",
                table: "service_jobs",
                columns: new[] { "AssignedTechnicianId", "ScheduledStartUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_CustomerId",
                table: "service_jobs",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_TenantId_JobNumber",
                table: "service_jobs",
                columns: new[] { "TenantId", "JobNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_service_jobs_TenantId_Status",
                table: "service_jobs",
